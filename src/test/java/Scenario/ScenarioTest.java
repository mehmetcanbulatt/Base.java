...
public class ScenarioTest extends Base {
    ...
    public void TestScenario() {
        ...
        steps.clickToElement("div[class='dropdown cart-dropdown']");
        steps.waitSecond(2000);
        steps.sendKeysToElement("input[id='LoginEmail']","mehmetcanbulat10@gmail.com");
        steps.sendKeysToElement("input[id='Password']","1234MCMC");
